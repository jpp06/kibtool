...
class TestCopySearch(KibtoolTestCase):
  def test_copy_searchid(self):
  ...
  def test_copy_searchid_depend(self):
    (l_srcName, l_dstName) = self.create_indices()
...
# ./test_kibtool --kibfrom kibtool-src --kibto kibtool-dst --searchid search-1 --depend --copy
